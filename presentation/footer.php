...
?>	
	...
	<?php } ?>	
			...
			<!-- <p class="competition_string">
				<a href="<?php echo get_site_URL(); ?>competition"><span style="font-weight:bold; color:yellow; background-color: #333; padding: 1px 3px 2px;">Competition!</span> Click here for details on how to win t-shirts, toe-stops and gift certificates by answering questions!</a>
			</p> -->
